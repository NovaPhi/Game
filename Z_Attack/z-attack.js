...
class WallSegment {
    constructor(x, y, maxHp = 100) {
        ...
        this.maxHp  = maxHp;
        this.hp     = maxHp;
        this.shootCooldown    = Math.floor(Math.random() * 150); // stagger so they don't all fire at once
        this.shootCooldownMax = 300; // 1 shot/sec at 60fps
    }
...
class Outpost {
    constructor(x, y) {
        ...
        this.maxHp  = 99;
        this.hp     = this.maxHp;
        this.shootCooldown    = Math.floor(Math.random() * 300);
        this.shootCooldownMax = 300; // 3 shots/sec at 60fps
    }
